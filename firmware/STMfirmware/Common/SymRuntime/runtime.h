...
#define SIZE_SYM_BLD_FLOAT          7      // | FCODE(1) | symID(2)         | val(4)      |
#define SIZE_SYM_BLD_FLOAT_DBL      11     // | FCODE(1) | symID(2)         | val(8)      |
#define SIZE_SYM_BLD_BOOL           4      // | FCODE(1) | symID(2)         | val(1)      |
#define SIZE_SYM_BLD_PATH_CNSTR     4      // | FCODE(1) | symID(2)         | val(1)      |
