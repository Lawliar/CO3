...
static void  MIDIMsgBuilder_updateIfSTATUS(MIDIMsgBuilder *mmb, MIDIMsg_Byte_t byte) __attribute__((unused));
...
static void MIDIMsgBuilder_updateIfCOMPLETE(MIDIMsgBuilder *mmb) __attribute__((unused));
